...
export default function Login() {
  ...
  const payloadChanged = (value, key) =>
  ...
  const loginUser = async (e) => {
    ...
    try {
      ...
      if (data?.success) {
        ...
        const message =
          errorMessages[data?.responseCodes?.[0]?.responseKey] ||
    ...
    <div className="container">
      <form className="loginDiv" onSubmit={loginUser}>
        ...
        <Input
          ...
          onChange={(e) => payloadChanged(e.target.value, "username")}
        />
        <Input
          ...
          onChange={(e) => payloadChanged(e.target.value, "password")}
        />
